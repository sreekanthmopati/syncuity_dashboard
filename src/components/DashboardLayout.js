                ...
                {sendSuccess ? (
                  ...
                  <>
                    <textarea
                      ...
                      placeholder="Type your message to all asset owners..."
                    />
          ...
          <div className="mt-2 space-y-2">
            {nelloreUnit.commercialAssets.map(asset => (
              <motion.div 
                ...
                className="flex justify-between items-center text-xs p-2 rounded-lg hover:bg-white/80 transition-all border border-transparent hover:border-purple-100 bg-white/50 backdrop-blur-sm"
              >
          ...
          <div className="mt-2 space-y-2">
            {nelloreUnit.nonCommercialAssets.map(asset => (
              <motion.div 
                ...
                className="flex justify-between items-center text-xs p-2 rounded-lg hover:bg-white/80 transition-all border border-transparent hover:border-blue-100 bg-white/50 backdrop-blur-sm"
              >
                <span className="truncate text-gray-700 font-medium">{asset.type}</span>
...
>
  ...
  {/* Compact footer */}
  <div className="mt-1 pt-1 border-t border-green-100 flex justify-between items-center">
    <p className="text-[0.6rem] text-gray-400">End of Statement</p>
    <div className="flex items-center">
      <FaShieldAlt className="text-green-400 text-[0.6rem] mr-0.5" />
      <span className="text-[0.6rem] text-gray-400">Secure</span>
    </div>
  </div>
</motion.div>
